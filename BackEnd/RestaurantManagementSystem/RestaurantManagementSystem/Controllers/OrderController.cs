...
namespace RestaurantManagementSystem.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        {
            var order = await _context.OrderMasters.FirstOrDefaultAsync(c => c.OrderMasterId == id);
            return Ok(order);
        }
        ...
        public async Task<ActionResult<List<OrderMaster>>> PutOrderMaster(long id, InsertOrderMasterDto dtoOrderMaster)
        {
            ...
            update.FoodName = dtoOrderMaster.FoodName;
            update.FoodPrice = dtoOrderMaster.FoodPrice;
            update.Quantity = dtoOrderMaster.Quantity;
        ...
        public async Task<ActionResult<List<OrderMaster>>> PostOrderMaster(InsertOrderMasterDto dtoOrderMaster)
        {
            ...
            var ordermaster = new OrderMaster
            {
                ...
                FoodName = dtoOrderMaster.FoodName,
                FoodPrice = dtoOrderMaster.FoodPrice,
                Quantity = dtoOrderMaster.Quantity,
